    ...
    return function (e) {
        ...
        var i = /mobile/i.test(window.navigator.userAgent), a = {
            secondToTime: function (e) {
                ...
                dragStart: i ? "touchstart" : "mousedown", dragMove: i ? "touchmove" : "mousemove",
        ...
        var w = {
            play: i.default, pause: a.default, volumeUp: r.default, volumeDown: o.default, volumeOff: s.default,
            orderRandom: l.default, orderList: u.default, menu: c.default, loopAll: p.default, loopOne: d.default,
            loopNone: h.default, loading: y.default, right: f.default, skip: v.default, lrc: m.default
        };
        t.default = w
    }, function (e, t, n) {
        "use strict";
            ...
            if ("object" === ("undefined" == typeof window ? "undefined" : r(window)) && void 0 !== document.querySelectorAll && void 0 !== window.pageYOffset && void 0 !== history.pushState) {
                ...
                return document.addEventListener("DOMContentLoaded", function () {
                    for (var e, t = document.querySelectorAll('a[href^="#"]:not([href="#"])'),
                             i = t.length; e = t[--i];)e.addEventListener("click", n, !1)
                }), t
            }
        ...
        var l = function () {
            function e(t) {
                ...
                }(this, e), this.player = t, this.index = 0, this.audios = this.player.options.audio, this.showing = !0, this.bindEvents()
            }
            ...
            return i(e, [{
                ...
                key: "show", value: function () {
                    this.showing = !0, this.player.template.list.scrollTop = 33 * this.index, this.player.template.list.style.height = Math.min(this.player.template.list.scrollHeight, this.player.options.listMaxHeight) + "px", this.player.events.trigger("listshow")
                }
            }, {
                key: "hide", value: function () {
                    var e = this;
                    this.showing = !1, this.player.template.list.style.height = "${Math.min(this.player.template.list.scrollHeight, this.player.options.listMaxHeight)}px", setTimeout(function () {
                        e.player.template.list.style.height = "0px", e.player.events.trigger("listhide")
                    }, 0)
                }
            }, {
                ...
                key: "add", value: function (e) {
                    ...
                    this.player.template.list.innerHTML += (0, a.default)({
            ...
            return i(e, [{
                ...
                key: "initPlayBar", value: function () {
                    var e = this, t = function (t) {
                        var n = ((t.clientX || t.changedTouches[0].clientX) - e.player.template.barWrap.getBoundingClientRect().left) / e.player.template.barWrap.clientWidth;
                        ...
                        var r = ((i.clientX || i.changedTouches[0].clientX) - e.player.template.barWrap.getBoundingClientRect().left) / e.player.template.barWrap.clientWidth;
                        r = Math.max(r, 0), r = Math.min(r, 1), e.player.bar.set("played", r, "width"), e.player.seek(r * e.player.duration), e.player.disableTimeupdate = !1
                    };
                ...
                key: "initVolumeButton", value: function () {
                    ...
                    this.player.template.volumeButton.addEventListener("click", function () {
                        e.player.audio.muted ? e.player.volume(e.player.audio.volume, !0) : (e.player.audio.muted = !0, e.player.switchVolumeIcon(), e.player.bar.set("volume", 0, "height"))
                    });
                    var t = function (t) {
                        var n = 1 - ((t.clientY || t.changedTouches[0].clientY) - e.player.template.volumeBar.getBoundingClientRect().top) / e.player.template.volumeBar.clientHeight;
                        ...
                        var r = 1 - ((i.clientY || i.changedTouches[0].clientY) - e.player.template.volumeBar.getBoundingClientRect().top) / e.player.template.volumeBar.clientHeight;
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = function (e) {
            var t = {
                container: e.element || document.getElementsByClassName("aplayer")[0], mini: e.narrow || e.fixed || !1,
                fixed: !1, autoplay: !1, mutex: !0, lrcType: e.showlrc || e.lrc || 0, preload: "metadata",
                theme: "#b7daff", loop: "all", order: "list", volume: .7, listFolded: e.fixed,
                listMaxHeight: e.listmaxheight || 250, audio: e.music || [], storageName: "aplayer-setting"
            };
            for (var n in t)t.hasOwnProperty(n) && !e.hasOwnProperty(n) && (e[n] = t[n]);
            return e.listMaxHeight = parseFloat(e.listMaxHeight), "[object Array]" !== Object.prototype.toString.call(e.audio) && (e.audio = [e.audio]), e.audio.map(function (e) {
                return e.name = e.name || e.title || "Audio name", e.artist = e.artist || e.author || "Audio artist", e.cover = e.cover || e.pic, e.type = e.type || "normal", e
        ...
        e.exports = '<span class="ico-pause"></span>'
    }, function (e, t) {
        e.exports = '<span class="ico-play"></span>'
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = function (e) {
        ...
        }, n(36), t.setImmediate = setImmediate, t.clearImmediate = clearImmediate
    }, function (e, t, n) {
        "use strict";
        (function (e) {
            Object.defineProperty(t, "__esModule", {value: !0});
            var i, a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
                ...
                return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
            }, r = n(34), o = (i = r) && i.__esModule ? i : {default: i};
            var s = setTimeout;
            ...
            function c(e, t) {
                ...
                0 !== e._state ? (e._handled = !0, u._immediateFn(function () {
                    ...
                    if (null !== n) {
                        ...
                        p(t.promise, i)
                    } else(1 === e._state ? p : d)(t.promise, e._value)
                })) : e._deferreds.push(t)
            }
            ...
            function p(e, t) {
                try {
                    ...
                    if (t && ("object" === (void 0 === t ? "undefined" : a(t)) || "function" == typeof t)) {
                        ...
                        if ("function" == typeof n)return void y((i = n, r = t, function () {
                            i.apply(r, arguments)
                        }), e)
                    }
            ...
            u.prototype.catch = function (e) {
            ...
            }, u.prototype.finally = o.default, u.all = function (e) {
                ...
                return e && "object" === (void 0 === e ? "undefined" : a(e)) && e.constructor === u ? e : new u(function (t) {
                    t(e)
                })
            }, u.reject = function (e) {
                return new u(function (t, n) {
        ...
        var i = function () {
            ...
            }(), a = v(n(38)), r = v(n(0)), o = v(n(3)), s = v(n(18)), l = v(n(17)), u = v(n(13)), c = v(n(12)),
        ...
        var m = [], g = function () {
            function e(t) {
                if (function (e, t) {
                        if (!(e instanceof t))throw new TypeError("Cannot call a class as a function")
                    }(this, e), this.options = (0, s.default)(t), this.container = this.options.container, this.paused = !0, this.playedPromise = a.default.resolve(), this.mode = "normal", this.randomOrder = r.default.randomOrder(this.options.audio.length), this.container.classList.add("aplayer"), this.options.lrcType && !this.options.fixed && this.container.classList.add("aplayer-withlrc"), this.options.audio.length > 0 && this.container.classList.add("aplayer-withlist"), r.default.isMobile && this.container.classList.add("aplayer-mobile"), this.arrow = this.container.offsetWidth <= 300, this.arrow && this.container.classList.add("aplayer-arrow"), this.container = this.options.container, 2 === this.options.lrcType || !0 === this.options.lrcType)for (var n = this.container.getElementsByClassName("aplayer-lrc-content"),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             i = 0; i < n.length; i++)this.options.audio[i] && (this.options.audio[i].lrc = n[i].innerHTML);
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), n(41);
        var i, a = n(39), r = (i = a) && i.__esModule ? i : {default: i};
        console.log("\n %c APlayer v1.10.1 925a44f %c http://aplayer.js.org \n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;"), t.default = r.default
    }]).default
});
