	...
	var listInfo = userWorkList(num,pageSize);
		...
		if(pageCat == AC_MUSIC){
			...
			for(var i in list){
				...
				'<img src="'+list[i]['urlMini']+'" class="showimg"></a>'+'<strong>'+list[i]['title']+'</strong>'+
...
function getUserWorkNum(){
	$.post('/work/userwapworknum',{uId:queryString('id')},function(r){
